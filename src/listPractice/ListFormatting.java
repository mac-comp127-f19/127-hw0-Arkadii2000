...
public class ListFormatting {
    ...
    public static List<String> numberEachItem(List<String> items) {
        ...
        for(String text : items) {
            track = items.indexOf(text) + 1;
            String huh = Integer.toString(track);
            mutable.add(huh + ". " + text);
        }
        return mutable;
    }
     ...
     */
    public static List<String> formatWithCommas(List<String> items) {
      String empty = ", ";
        List<String> mutable = new ArrayList<>();
        for(String text : items){

          mutable.add(text + empty);
        }
        return mutable;
    }
